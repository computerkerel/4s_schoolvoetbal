...
@section('content')
	<div class="container">
		...
		<form action="{{route('teams.destroy', $team->id)}}" method="POST">
			@csrf
			@method('DELETE')
			<input type="button" class="btn btn-danger" id="delete-team" value="Verwijderen" data-bs-toggle="modal"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Als je dit team verwijderd worden ook alle wedstrijden van dit team verwijderd.</p>
